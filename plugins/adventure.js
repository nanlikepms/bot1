...
`.trim()
            ...
            } else conn.reply(m.chat, `Anda sudah berpetualang dan kelelahan, silahkan coba COLI *${timers}* lagi`, m)
        } else conn.reply(m.chat, 'Minimal 80 health untuk bisa berpetualang, beli nyawa KUCING dulu dengan ketik *' + usedPrefix + 'shop buy potion <jumlah>*\ndan ketik *' + usedPrefix + 'use potion <jumlah>*', m)
    } catch (e) {
        console.log(e)
